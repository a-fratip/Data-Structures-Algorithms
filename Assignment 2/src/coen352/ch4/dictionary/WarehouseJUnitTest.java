...
public class WarehouseJUnitTest {
    ...
    void testCreateListIndex() {
        ...
        wh.insertRecord("IN0003",ir3);
        wh.insertRecord("IN0004",ir4);
        int[] unitPriceIndex = wh.createListIndex("Unit Price");
        assertEquals(3,unitPriceIndex[0]);
        assertEquals(0,unitPriceIndex[1]);
        assertEquals(2,unitPriceIndex[2]);
        assertEquals(1,unitPriceIndex[3]);
        int[] inventoryValueIndex = wh.createListIndex("Inventory Value");
        assertEquals(0,inventoryValueIndex[0]);
        assertEquals(3,inventoryValueIndex[1]);
        assertEquals(2,inventoryValueIndex[2]);
        assertEquals(1,inventoryValueIndex[3]);
    }

    @Test
    void testCreateTreeIndex() {
        wh.clearDatabase();
        InventoryRecord ir1 = new InventoryRecord("Item 1", "Desc 1", 51.00, 25, 1275.00, 29, 13, 50, false);
        InventoryRecord ir2 = new InventoryRecord("Item 2","Desc 2",93.00,132,12276.00,231,4,50,false);
        InventoryRecord ir3 = new InventoryRecord("Item 3","Desc 3",57.00,25,8607.00,114,11,150,false);
        ...
        wh.insertRecord("IN0003",ir3);
        wh.insertRecord("IN0004",ir4);
        int[] unitPriceIndex = wh.createTreeIndex("Unit Price");
        assertEquals(3,unitPriceIndex[0]);
        assertEquals(0,unitPriceIndex[1]);
        assertEquals(2,unitPriceIndex[2]);
        assertEquals(1,unitPriceIndex[3]);
        int[] inventoryValueIndex = wh.createTreeIndex("Inventory Value");
        assertEquals(0,inventoryValueIndex[0]);
        assertEquals(3,inventoryValueIndex[1]);
        assertEquals(2,inventoryValueIndex[2]);
        assertEquals(1,inventoryValueIndex[3]);
    ...
    // Problem 3 unit test cases are given below
    @Test
    void testQueryUnitPrices() {
        wh.clearDatabase();
        InventoryRecord ir1 = new InventoryRecord("Item 1", "Desc 1", 51.00, 25, 1275.00, 29, 13, 50, false);
        InventoryRecord ir2 = new InventoryRecord("Item 2","Desc 2",93.00,132,12276.00,231,4,50,false);
        InventoryRecord ir3 = new InventoryRecord("Item 3","Desc 3",57.00,25,8607.00,114,11,150,false);
        ...
        wh.query("Unit Price",3);
        assertEquals("IN0002, IN0003, IN0001\n",output.toString());
        System.setOut(null);
    }

    @Test
    void testQueryInventoryRecords() {
        wh.clearDatabase();
        InventoryRecord ir1 = new InventoryRecord("Item 1", "Desc 1", 51.00, 25, 1275.00, 29, 13, 50, false);
        InventoryRecord ir2 = new InventoryRecord("Item 2","Desc 2",93.00,132,12276.00,231,4,50,false);
        InventoryRecord ir3 = new InventoryRecord("Item 3","Desc 3",57.00,25,8607.00,114,11,150,false);
        ...
        ByteArrayOutputStream output = new ByteArrayOutputStream();
        System.setOut(new PrintStream(output));
        wh.query("Inventory Value",4);
        assertEquals("IN0002, IN0003, IN0004, IN0001\n",output.toString());
        System.setOut(null);
    }
