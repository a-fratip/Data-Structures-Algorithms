...
public class DictionaryJUnitTest {
	...
	public static void setUp() {
		dict = new DDictionary<Integer, String>(10);
	...
	void testRemove() {
		...
		assertNotEquals("red", dict.find(0));

		assertEquals("blue",dict.find(1));
		assertEquals("yellow",dict.find(2));
	...
	void testRemoveAny() {
		...
		assertNotEquals("grey",dict.find(3));
